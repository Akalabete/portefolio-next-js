    ...
    >
      ...
      <div className="flex flex-row items-center ">
        ...
        <div className="flex flex-row space-x-2 items-center">
          ...
          <span className=" font-sans text-AAsecondary text-base">Et Maintenant?</span>
        </div>
      </div>
      {/* // ? Get In Touch */}
      <span className="text-gray-200 text-3xl sm:text-4xl font-bold tracking-wider opacity-85">Prendre Contact</span>
      <p className="flex font-Header tracking-wider text-gray-400 text-center px-6 sm:px-16 md:px-0 md:w-[600px]">
        Ouvert à toutes propositions, que vous ayez des projets à concrétiser, ou
